  ...
  return (
    <div className="absolute flex flex-col gap-[100px] top-1/2 left-1/2 -translate-1/2 md:left-0 md:translate-x-0 w-full max-w-[1470px] z-10">
      ...
      <div className="px-4 md:p-0 mt- w-full max-w-[1470px]">
        <div className="bg-white w-full rounded-2xl md:rounded-l-none flex flex-col justify-between md:flex-row">
          <form className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-5 items-center">
            {/* Destination Input */}
            <label>
              <TextField
                id="standard-basic"
          ...
          {/* Submit */}
          <div className="w-full md:w-fit bg-primary rounded-b-2xl md:rounded-r-2xl! md:rounded-b-none px-5 py-10 text-4xl text-white flex items-center justify-between">
